...
//TYPE_32R
  ...
  INSTPAT("0000001 ????? ????? 010 ????? 01100 11", mulhsu , R, R(dest) = (int32_t)BITS((int64_t)src1 * (uint64_t) src2, 63,32));//未验证
  INSTPAT("0000001 ????? ????? 011 ????? 01100 11", mulhu  , R, R(dest) = (int32_t)BITS((uint64_t)src1 * (uint64_t) src2, 63,32)); //未验证
